...
<%
    ...
    String applicationHandle = "BBCourseRestWebService";
%>
<bbData:context>
...
%>
            <a href="/webapps/amnl-BBCourseRestWebService-<%= bbUid %>/resources">Base resource uri</a>&nbsp;/&nbsp;
            <a href="/webapps/amnl-BBCourseRestWebService-<%= bbUid %>/resources/application.wadl">Click for wadl</a><br/>
